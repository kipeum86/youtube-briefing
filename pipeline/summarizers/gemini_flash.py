...
다음은 유튜브 채널 "{channel_name}"의 영상 "{title}"에서 추출한 트랜스크립트입니다. 이 영상의 핵심 내용을 500~1,000자 한국어로 요약해 주세요.

요약은 다음 구조를 정확히 따라야 합니다:

1. 주제 한 줄 (15자 이내, 문장 아닙니다, 개조식)
2. 핵심 주장 2~3문장 — 영상이 말하려는 테제를 직설적으로
3. 근거/데이터 3~5문장 — 구체적인 숫자, 사례, 인용, 정책 언급
4. 함의 1~2문장 — 이 이야기가 왜 지금 중요한가

절대 금지:
- "이 영상은 ~에 대해 이야기합니다" 같은 메타 설명
- "~일 수도 있습니다", "~라고 생각합니다" 같은 헷지 표현 (영상이 그렇게 말하지 않는 한)
- 화자가 말하지 않은 내용의 추측
- 영어 단어로 도피 (경제 용어는 한국어로, 고유명사만 영문 허용)
...
위 트랜스크립트의 500~1,000자 한국어 심층 요약:"""
